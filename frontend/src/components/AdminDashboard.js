...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    { id: 5, name: "Michael Johnson", email: "michael@example.com", balance: 15000, invested: 10000, joinDate: "2024-03-01", phone: "+1-555-0127", status: "active", riskProfile: "moderate", tradingStatus: "active" },
    { id: 6, name: "Lisa Park", email: "lisa@example.com", balance: 320000, invested: 250000, joinDate: "2023-12-15", phone: "+1-555-0128", status: "active", riskProfile: "aggressive", tradingStatus: "active" },
    { id: 7, name: "David Wilson", email: "david@example.com", balance: 95000, invested: 80000, joinDate: "2024-01-28", phone: "+1-555-0129", status: "inactive", riskProfile: "conservative", tradingStatus: "inactive" }
  ];
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
            <div>
              ...
              <p className={`text-sm ${textSecondaryClass}`}>Active monitoring with investor-selected weekly risk (0.5%–5%)</p>
            </div>
